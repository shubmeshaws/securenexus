...
export const SECURITY_TOOLS: SecurityToolDefinition[] = [
  ...
  },
  {
    ...
    name: 'pip-audit',
    category: 'sca',
    description: 'Python dependency vulnerability scanner for requirements.txt and pyproject.toml projects.',
  ...
  },
  {
    ...
    name: 'govulncheck',
    category: 'sca',
    description: 'Official Go vulnerability scanner for modules in go.mod using the Go vulnerability database.',
    website: 'https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck',
    color: '#00add8',
    initials: 'GV',
  },
  {
